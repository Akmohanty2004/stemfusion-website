    ...
    <nav style={{
      ...
      <div style={{ display: "flex", gap: "clamp(15px, 3vw, 30px)", alignItems: "center" }} className="desktop-nav">
        ...
        <div style={{ display: "flex", gap: 10 }}>
          <a href="https://www.instagram.com/stemfussion?utm_source=qr&igsh=MTVvYjF0aWswaG1kMw%3D%3D" target="_blank" rel="noreferrer"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcS7g6s52v9CUHQrqC2jiAmW_F9qw2FQGqjbEacyNSkpPQ&s=10" alt="IG" style={{ width: 28, height: 28, borderRadius: "50%", transition: "all 0.3s" }}
            onMouseEnter={e => e.currentTarget.style.transform = "scale(1.1)"}
            onMouseLeave={e => e.currentTarget.style.transform = "scale(1)"} /></a>
          <a href="https://www.facebook.com/share/1DNHyqciVj/" target="_blank" rel="noreferrer"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSHdxqvC6ycgnQzWZu6i8GgonJZY_5ptmntd3f2txAYuw&s=10" alt="FB" style={{ width: 28, height: 28, borderRadius: "50%", transition: "all 0.3s" }}
            onMouseEnter={e => e.currentTarget.style.transform = "scale(1.1)"}
            onMouseLeave={e => e.currentTarget.style.transform = "scale(1)"} /></a>
          <a href="https://youtube.com/@stemfusion" target="_blank" rel="noreferrer"><img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcT_NG5j-5E7wBm336vUN545eIHAJ7JOiAmubajzRSQSzw&s" alt="YT" style={{ width: 28, height: 28, borderRadius: "50%", transition: "all 0.3s" }}
            onMouseEnter={e => e.currentTarget.style.transform = "scale(1.1)"}
            onMouseLeave={e => e.currentTarget.style.transform = "scale(1)"} /></a>
        </div>
      </div>
